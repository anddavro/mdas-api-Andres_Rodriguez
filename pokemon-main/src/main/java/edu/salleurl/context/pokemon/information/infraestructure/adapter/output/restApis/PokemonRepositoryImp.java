package edu.salleurl.context.pokemon.information.infraestructure.adapter.output.restApis;
...
import edu.salleurl.context.pokemon.user.domain.service.ListenerFavorites;
...
public class PokemonRepositoryImp implements PokemonRepository {
    ...
    public Optional<Pokemon> getPokemonInformation(Id pokemonId) throws RepositoryNotRespondingException, NotFoundException {
        ...
        try {
            ...
            edu.salleurl.context.pokemon.information.infraestructure.adapter.output.restApis.dto.Pokemon pokemon = mapper.readValue(response.body(), edu.salleurl.context.pokemon.information.infraestructure.adapter.output.restApis.dto.Pokemon.class);
