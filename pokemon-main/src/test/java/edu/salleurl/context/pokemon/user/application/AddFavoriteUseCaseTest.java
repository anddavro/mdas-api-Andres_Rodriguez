...
class AddFavoriteUseCaseTest {
    ...
    @Test
    public void AddFavoriteUseCaseTest() throws PokemonFavoriteExistsException, UserDontExistException, InterruptedException {
        String id="id";
    ...
    @Test
    public void AddFavoriteUseCasePokemonFavoriteExistsExceptionTest() throws PokemonFavoriteExistsException, UserDontExistException, InterruptedException {
        String id="id";
        String pokemonId = "pId";
        User user = new User(id, new HashSet<>());
        Mockito.when(finder.find(id)).thenReturn(user);
