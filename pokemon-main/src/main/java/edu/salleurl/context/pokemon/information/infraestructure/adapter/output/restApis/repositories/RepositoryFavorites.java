package edu.salleurl.context.pokemon.information.infraestructure.adapter.output.restApis.repositories;
...
@Repository
public interface RepositoryFavorites extends CrudRepository<totalFavoritesEntity,String> {
