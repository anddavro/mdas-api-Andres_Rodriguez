...
public class AddFavoritePokemonController {
    ...
    totalFavorites listener = new totalFavorites();
    @PostMapping(path = "/add-favorite-pokemon")
    public ResponseEntity<CreateUserResponse> addFavoritePokemon(@RequestBody AddFavoritePokemonRequest request, @RequestHeader("user") String user) throws UserDontExistException, PokemonFavoriteExistsException, InterruptedException {
